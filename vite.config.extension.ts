  ...
  resolve: {
    alias: {
      ...
      '@ai-sdk/openai-compatible': resolve(
        __dirname,
        'node_modules/.pnpm/@ai-sdk+openai-compatible@1.0.28_patch_hash=5ea49b4f07636a8e4630097e67e2787779ba7e933bd0459f81b1803cb125edda_zod@4.3.5/node_modules/@ai-sdk/openai-compatible'
      ),
